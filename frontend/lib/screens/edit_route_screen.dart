...
class _EditRouteScreenState extends State<EditRouteScreen> {
  ...
  void initState() {
    super.initState();
    labelController = TextEditingController(text: widget.route.routeLabel);
    sourceController = TextEditingController(text: widget.route.sourceAddress);
    destinationController = TextEditingController(
      text: widget.route.destinationAddress,
    );
    delayController = TextEditingController(
      text: widget.route.delayThreshold.toString(),
    );
    selectedTime = widget.route.alertTime;
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Edit Route', style: TextStyle(color: AppColors.heading)),
      ),
      backgroundColor: AppColors.background,
      body: Padding(
